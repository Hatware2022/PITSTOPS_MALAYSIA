...
function SearchMyTaskResult({ navigation }) {
            ...
            <View style={{ flex: 1, marginTop: 60, marginLeft: 20, marginRight: 20 }}>
                <View style={{ width: '100%', height: 30, marginTop: 10, flexDirection: 'row' }}>
                    <View style={{ flex: 1, justifyContent: 'center' }}>
                        <Text> {searchmyTaskResultList.length} tasks available</Text>
                    </View>
...
export default SearchMyTaskResult;