...
class RadioButtonRN extends React.Component {
    ...
    render() {
        ...
        let { boxStyle, style, circleSize, textStyle, spacerWidth, data, icon, activeColor, deactiveColor, activeBorderColor, deactiveBorderColor, boxActiveBgColor, boxDeactiveBgColor, box, textColor } = this.props;
                        ...
                        return (
                            <TouchableOpacity
                                ...
                                box && {
                                    ...
                                    borderColor: activeIndex === index ? activeBorderColor : deactiveBorderColor,
                                }
                                    , boxStyle]}
                                activeOpacity={0.9}
                            ...
                            >
                                <View style={styles.leftProductBox}>
                                    ...
                                    icon && {
                                        borderColor: activeIndex === index ? 'transparent' : deactiveBorderColor
                                    }
                                    ]}>
                                        <Animated.View style={{
                                ...
                                <View style={spacerWidth ? { width: spacerWidth } : { width: 10 }} />
...
RadioButtonRN.defaultProps = {
    ...
    activeBorderColor: '#DCDCE6',
    deactiveBorderColor: '#DCDCE6',
    textColor: '#383838',
    box: true,
    spacerWidth: 10
};
